...
//////////////////////////////////////////////////////////////////////////
// ABloodSurfaceResearchCharacter

ABloodSurfaceResearchCharacter::ABloodSurfaceResearchCharacter()
{
...
void ABloodSurfaceResearchCharacter::NotifyControllerChanged()
{
...
void ABloodSurfaceResearchCharacter::StartCameraRotation()
{
...
void ABloodSurfaceResearchCharacter::StopCameraRotation()
{
	APlayerController* PlayerController = Cast<APlayerController>(Controller);
	if (!PlayerController) return;
...
void ABloodSurfaceResearchCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ABloodSurfaceResearchCharacter::Move);
...
void ABloodSurfaceResearchCharacter::MakeBlood()
{
	...
	const bool bHit = PC->GetHitResultUnderCursor(
		ECC_Visibility,
		true,
		Hit
	);
...
void ABloodSurfaceResearchCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
